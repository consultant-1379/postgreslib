...
EXTR_NAME="EXTRpostgreslib2"
PKG_NAME="postgresql13-libs"
PREVIOUS_PKG_1="postgresql12-libs-12.6-1PGDG.rhel7.x86_64.rpm"
PREVIOUS_PKG_2="postgresql13-libs-13.8-1PGDG.rhel7.x86_64.rpm"
# For the Future uplift use the following 2 Previous_PKGs
#PREVIOUS_PKG_1="postgresql13-libs-13.8-1PGDG.rhel7.x86_64.rpm"
#PREVIOUS_PKG_2="postgresql13-libs-13.8-1PGDG.rhel8.x86_64.rpm"
RPM_PATH="/opt/ericsson/pgsql/rpm2/lib/resources/"
RPM_PATH_OLD="/opt/ericsson/pgsql/rpm/lib/resources/"
...
if [ $IS_RHEL7 -eq 0 ]; then
  PKG="postgresql13-libs-13.8-1PGDG.rhel7.x86_64.rpm"
  log debug "RHEL7 Deployment: Installing ${PKG}"
else
  PKG="postgresql13-libs-13.8-1PGDG.rhel8.x86_64.rpm"
